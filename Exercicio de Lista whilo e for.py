...
serao convidados para uma festa apos isso o programa ira perguntar o nome de todas as pessoas
e colocar numa lista de convidados e por final ira impimir  todos os nomes  da lista
'''
